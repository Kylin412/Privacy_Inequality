...
from config_consumer import API_KEY, API_BASE_URL, MODEL_NAME, TEMPERATURE, PROMPT_TEMPLATE
...
def call_model(prompt: str) -> str:
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            print(f"✅ Model call successful (attempt {attempt})")
            return text
...
def process_csv_once(input_path: str, output_path: str):
    """Single experiment: process CSV, call model, write JSONL"""
...
def main():
    # ---- Parameter interface ----
    input_csv = "allgrok.csv"       # Source CSV
